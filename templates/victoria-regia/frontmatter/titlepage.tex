...
\begin{tikzpicture}[remember picture,overlay]
    ...
    % Timeline-specific motif (dynamic based on timeline)
    \IfStrEqCase{\timelinename}{%
      {eros}{\input{global/motifs/eros-motif}}%
      {anima}{\input{global/motifs/anima-motif}}%
      {bloom}{\input{global/motifs/bloom-motif}}%
    }[\input{global/motifs/bloom-motif}]% default fallback
    ...
    \node[anchor=north, above=2pt of publisher.north]
        {\includegraphics[width=0.15\textwidth]{global/images/logo-white.png}};
